                                ...
                                <div id="navbar" className="collapse navbar-collapse navigation-holder">
                                    ...
                                    <li className="menu-item-has-children">
                                            ...
                                            <ul className="sub-menu">
                                                ...
                                                <li><NavLink onClick={ClickHandler} to="/home3">Announcement Home</NavLink></li>
                                                <li><NavLink onClick={ClickHandler} to="/home4">Wedding Home</NavLink></li>
                                                <li><NavLink onClick={ClickHandler} to="/home5">Asian / Indian Wedding Announcement</NavLink></li>
                                                <li><NavLink onClick={ClickHandler} to="/home6">Asian / Indian Wedding Planner</NavLink></li>
                                                <li><NavLink onClick={ClickHandler} to="/home7">Muslim Wedding</NavLink></li>
                                                <li><NavLink onClick={ClickHandler} to="/home8">Shop Home</NavLink></li>
                                                <li><NavLink onClick={ClickHandler} to="/home9">Wedding Invitation</NavLink></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><Link className="navbar-brand" to="/"><img src={Logo}
                                        alt="" /></Link></li>
